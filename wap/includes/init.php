...
require(ROOT_PATH . 'includes/cls_shopwapp.php');
...
{
    echo "<!DOCTYPE wml PUBLIC '-//WAPFORUM//DTD WML 1.1//EN' 'http://www.wapforum.org/DTD/wml_1.1.xml'><wml><head><meta http-equiv='Cache-Control' content='max-age=0'/></head><card id='shopwapp' title='ShopWapp_WAP'><p align='left'>对不起,{$_CFG['shop_name']}暂时没有开启WAP功能</p></card></wml>";
    exit();
}
