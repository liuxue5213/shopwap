...
class CategoryController extends CommonController {
    ...
    public function keywords() {
        ...
        if ($keywords != '') {
             ...
             * 处理关键字查询次数
             */
            $sql = 'INSERT INTO ' . $this->model->pre . "keywords (date , searchengine,keyword ,count) VALUES ('" . local_date('Y-m-d') . "', '" . SWTouch . "', '" . addslashes(str_replace('%', '', $val)) . "', '1')";
    ...
    public function top_all() {
        ...
        if (!SWTouch::view()->is_cached('category_all.dwt', $cache_id)) {
