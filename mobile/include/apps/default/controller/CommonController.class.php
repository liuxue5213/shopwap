...
class CommonController extends BaseController
{
    ...
    protected function shopwapp_init()
    {
        ...
        if (! empty($stylename)) {
            $this->assign('swtouch_css_path', __ROOT__ . '/themes/' . C('template') . '/css/swtouch_' . C('stylename') . '.css');
        } else {
            $this->assign('swtouch_css_path', __ROOT__ . '/themes/' . C('template') . '/css/swtouch.css');
        }
    }
}

class_alias('CommonController', 'SWTouch');
