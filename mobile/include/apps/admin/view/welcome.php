...
<script src="http://www.gope.cn/apis/notice.html"></script>
<script src="http://www.gope.cn/apis/patch.html?release=<?php echo RELEASE;?>"></script>
...
<div class="panel panel-default">
  ...
  <div class="panel-body" style="padding:0;">
    <table class="table table-hover swtouch-table">
      <tr>
        <td width="15%">{$lang['os']}</td>
        <td width="35%">{$sys_info['os']} ({$sys_info['ip']})</td>
        <td width="15%">{$lang['web_server']}</td>
        <td width="35%">{$sys_info['web_server']}</td>
      </tr>
      <tr>
...
<div class="panel panel-default">
  ...
  <div class="panel-body swtouch-line"> 强烈建议您将 data/config.php 文件属性设置为644（linux/unix）或只读权限（WinNT）<br>
...
<div class="panel panel-default">
  ...
  <div class="panel-body swtouch-line"> 未经商业授权，不得将本软件用于商业用途(企业网站或以盈利为目的经营性网站)，否则我们将保留追究的权力。<br>
    用户自由选择是否使用本软件，在使用中出现任何问题和由此造成的一切损失官方将不承担任何责任；<br>
    利用 SWTouch 构建网站的任何信息内容以及导致的任何版权纠纷和法律争议及后果，SWTouch 官方不承担任何责任；<br>
    所有用户均可查看 SWTouch 的全部源代码，您可以对本系统进行修改和美化，但必须保留完整的版权信息;<br>
