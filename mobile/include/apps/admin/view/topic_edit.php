    ...
    <form action="{url('edit')}" method="post" name="theForm" enctype="multipart/form-data" class="form-horizontal" role="form">
      <div class="tab-content">
          ...
          <table id="general-table" class="table table-hover swtouch-table">
            ...
            <tbody id="content_01">
              <tr>
                ...
                <td><div class="col-md-4">
                  ...
                  {if $topic['topic_img']}
                  <div class="col-md-1"> <a href="javascript:;" class="glyphicon glyphicon-picture swtouch-fs16" style="text-decoration:none;" onClick="showImg('topic_img', '{$lang['top_img']}')" title="View"></a>
            ...
            <tr>
              ...
              <td><div class="col-md-4">
                ...
                {if $topic['title_pic']}
                <div class="col-md-1"> <a href="javascript:;" class="glyphicon glyphicon-picture swtouch-fs16" style="text-decoration:none;" onClick="showImg('title_pic', '{$lang['lable_title_upload']}')" title="View"></a>
        ...
        <div class="tab-pane" id="goods">
          <table width="90%" class="table table-hover swtouch-table">
            <tr>
            ...
            <tr>
              <td width="100%"><table width="90%" class="table table-hover swtouch-table">
                  <tr height="37">
