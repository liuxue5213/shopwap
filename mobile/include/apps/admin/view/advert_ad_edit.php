          ...
          <td>
            <div class="col-md-4">
              <input type="file" name="ad_img" class="form-control input-sm" />
               ...
               {if $ad_img}
              <div class="col-md-1">
                <a href="javascript:;" class="glyphicon glyphicon-picture swtouch-fs16" style="text-decoration:none;" onClick="showImg('ad_img_layer', '{$lang['ad_img']}')" title="{$lang['ad_code_img']}"></a><div id="ad_img_layer" style="display:none"><img src="{$ad_img}" border="0" /></div>
              </div>
              {/if}
