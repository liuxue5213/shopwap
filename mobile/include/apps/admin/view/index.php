...
<body>
<div id="admin_header">
  <div id="admin_logo"><span>ShopWapp B2C <br />移动端管理中心</span><a href="../swadmin" title="PC端管理中心" target="_blank"><span>ShopWapp B2C<br />PC端管理中心</span></a></div>
  <div id="submenu-div">
    <ul>
      <li><a href="{url('logout')}">{$lang['signout']}</a></li>
      <li><a href="{url('aboutus')}" target="mainFrame">{$lang['about']}</a></li>
      <li><a href="http://bbs.shopwapp.com" target="_blank">{$lang['help']}</a></li>
      ...
      <li style="border-left:none"><a href="javascript:window.top.frames['mainFrame'].document.location.reload();">{$lang['refresh']}</a></li>
    </ul>
  </div>
</div>
