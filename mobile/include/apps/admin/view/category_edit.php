      ...
      <table id="general-table" class="table table-hover swtouch-table">
        ...
        <tr>
          ...
          <td><div class="col-md-4">
              ...
              <div class="col-md-1">
                <a href="javascript:;" class="glyphicon glyphicon-picture swtouch-fs16" style="text-decoration:none;" onClick="showImg('cat_image_layer', '{$lang['cat_image']}')" title="View"></a>
