...
<form action="{url('init')}" method="post">
  <div class="panel panel-default">
    ...
    <div class="panel-body" style="padding:0;">
      <table class="table table-hover swtouch-table">
        <tr>
          <td width="70%">{$lang['currentversion']}<?php if(empty($pathlist)){ echo $lang['lastversion']; }?></td>
  ...
  <table class="table table-hover swtouch-table" style="border:1px #ddd solid; margin-bottom:10px;">
    <tr>
