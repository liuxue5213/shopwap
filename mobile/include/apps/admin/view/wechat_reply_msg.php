                ...
                <form action="{url('reply_msg')}" method="post">
                  <div class="panel panel-default">
                      ...
                      <ul class="nav nav-pills" role="tablist">
                        <li role="presentation"><a href="javascript:;" class="glyphicon glyphicon-pencil swtouch-fs18" title="文字"></a></li>
                        <li role="presentation"><a href="{url('auto_reply', array('type'=>'image'))}" class="glyphicon glyphicon-picture swtouch-fs18 fancybox fancybox.iframe" title="图片"></a></li>
                        <li role="presentation"><a href="{url('auto_reply', array('type'=>'voice'))}" class="glyphicon glyphicon-volume-up swtouch-fs18 fancybox fancybox.iframe"  title="语音"></a></li>
                        <li role="presentation"><a href="{url('auto_reply', array('type'=>'video'))}" class="glyphicon glyphicon-film swtouch-fs18 fancybox fancybox.iframe"  title="视频"></a></li>
                      </ul>
                      </div>
