...
.swtouch-table {margin:0;}
.swtouch-table tr:first-child td {border-top:none;}
.swtouch-line {line-height: 1.8;}
.swtouch-mb5, .breadcrumb {margin-bottom:5px}
.swtouch-fs16 {font-size:16px}
.swtouch-fs18 {font-size:18px}
.btn-primary {background-color:#468e33}
.panel-title {font-size:14px}
.pagination {margin-top:0}
.pagination .glyphicon {top:0}
.swtouch-mb{margin-bottom:5px;}
.clear{clear:both;}
.borderno{border:0;}
</style>
...
<div class="row" style="margin:0">
	<div class="pull-right swtouch-mb5"><a href="{$action_link['href']}" class="btn btn-primary">{$action_link['text']}</a></div>
</div>
{/if}