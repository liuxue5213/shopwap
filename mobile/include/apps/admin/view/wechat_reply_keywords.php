			...
			<div class="panel-body">
                ...
                <div class="form-group hidden rule_form">
        			<form action="{url('rule_edit')}" method="post" class="form-horizontal" role="form">
                      <table id="general-table" class="table table-hover swtouch-table">
                       <tr>
                                ...
                                <div class="panel panel-default">
                                     <div class="panel-heading">
                                      <ul class="nav nav-pills" role="tablist">
                                        <li role="presentation"><a href="javascript:;" class="glyphicon glyphicon-pencil swtouch-fs18" title="文字" type="text"></a></li>
                                        <li role="presentation"><a href="{url('auto_reply', array('type'=>'image'))}" class="glyphicon glyphicon-picture swtouch-fs18 fancybox fancybox.iframe" title="图片" type="image"></a></li>
                                        <li role="presentation"><a href="{url('auto_reply', array('type'=>'voice'))}" class="glyphicon glyphicon-volume-up swtouch-fs18 fancybox fancybox.iframe"  title="语音" type="voice"></a></li>
                                        <li role="presentation"><a href="{url('auto_reply', array('type'=>'video'))}" class="glyphicon glyphicon-film swtouch-fs18 fancybox fancybox.iframe"  title="视频" type="video"></a></li>
                                        <li role="presentation"><a href="{url('auto_reply', array('type'=>'news'))}" class="glyphicon glyphicon-list-alt swtouch-fs18 fancybox fancybox.iframe"  title="图文消息" type="news"></a></li>
                                      </ul>
                                      </div>
