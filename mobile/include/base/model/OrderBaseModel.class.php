...
class OrderBaseModel extends BaseModel {
    ...
    function virtual_goods_ship(&$virtual_goods, &$msg, $order_sn, $return_result = false, $process = 'other') {
        ...
        foreach ($virtual_goods AS $code => $goods_list) {
            ...
            if ($code == 'virtual_card') {
                ...
                SWTouch::view()->assign('virtual_card', $virtual_card);
            }
        }
    ...
    function virtual_card_shipping($goods, $order_sn, &$msg, $process = 'other') {
        ...
        /* 发送邮件 */
        SWTouch::view()->assign('virtual_card', $cards);
        SWTouch::view()->assign('order', $order);
        SWTouch::view()->assign('goods', $goods);

        SWTouch::view()->assign('send_time', date('Y-m-d H:i:s'));
