...
<section class="user-order-detail" style="border:0;">
...
?>
    ...
    <div class="ect-pro-list userOrderDetail">
    	<ul>
        	<?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
            <li>
            	<a href="<?php echo url('goods/index', array('id'=>$this->_var['goods']['goods_id']));?>" target="_blank">
                	<div class="pic"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>"></div>
                    <dl>
                    	<dt><h4 class="title"><?php echo $this->_var['goods']['goods_name']; ?></h4></dt>
                        <dd class="dd-price"><?php echo $this->_var['goods']['goods_price']; ?><em>×</em><?php echo $this->_var['goods']['goods_number']; ?><em>=</em><i><?php echo $this->_var['goods']['subtotal']; ?></i></dd>
                    </dl>
                </a>
            </li>
        	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
<section class="order-detail-info ect-margin-tb" style="margin-bottom:0;">
 ...
 <?php if ($this->_var['allow_edit_surplus']): ?>
    ...
    <section class="order-detail-info ect-margin-tb" style="border:0; margin-top:0;">
        <ul><li style="text-align:right;"> <b class="pull-left"> <?php echo $this->_var['lang']['use_more_surplus']; ?>：</b><span><input name="surplus" class="ect-padding-lr" type="text" size="8" value="0" /></span>
         <p class="ect-margin-tb"><?php echo $this->_var['max_surplus']; ?></p>
         </li></ul>
         </section>
          <section class="ect-padding-lr ect-padding-tb ect-margin-tb ect-margin-bottom0 mlr">
    ...
    <?php endif; ?>
    <span class="blank10"></span>
<section class="order-detail-info ect-margin-tb  ect-margin-bottom0" style="border-bottom:0;">
  <ul>
...
</section> <?php if ($this->_var['order']['order_amount'] > 0): ?>
<section class="ect-padding-lr ect-padding-tb ect-margin-tb ect-margin-bottom0 mlr"><?php echo $this->_var['order']['pay_online']; ?></section><?php endif; ?> 
<section class="order-detail-info ect-margin-tb ect-margin-bottom0 user-bottom0" style="border-top:0;">
  <ul>
