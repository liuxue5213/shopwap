...
?>
            <li>
                <div class="media panel-body">
                    <a href="<?php echo url('category/index',array('id'=>$this->_var['cat']['id']));?>"><div class="pull-left ect-category-right"><h3><?php echo htmlspecialchars($this->_var['cat']['name']); ?></h3></div></a>
                </div>
