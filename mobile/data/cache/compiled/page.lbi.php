<ul class="pager ect-margin-lr ect-page">
	  <li class="" style="float:left; padding-left:20px;"><a href="<?php echo empty($this->_var['pager']['page_prev']) ? '#' : $this->_var['pager']['page_prev']; ?>">上一页</a></li>
...
?>
	  ...
	  <?php endif; ?>
	  <li class="" style="float:right; padding-right:20px;"><a href="<?php echo empty($this->_var['pager']['page_next']) ? '#' : $this->_var['pager']['page_next']; ?>">下一页</a></li>
</ul> 