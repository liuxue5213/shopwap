 ...
 <?php endif; ?>
  <?php endif; ?>
    ...
    <div class="form-group bonus-form-group">
	  <div class="form-group-text" style="padding: 8px;"><input type="text" class="form-control" name="bonus_sn" placeholder="<?php echo $this->_var['lang']['bonus_number']; ?>"/></div>
	  
	  <div class="ect-padding-lr ect-padding-tb ect-margin-tb addressListBox"><input type="submit" class="btn btn-info ect-btn-info ect-colorf" value="<?php echo $this->_var['lang']['add_bonus']; ?>" /> </div>
	</div>
  </form>
