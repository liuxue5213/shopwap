...
/* 詳情頁 */
$_LANG['label_certificate_download'] = 'ShopWapp證書下載備份';
$_LANG['label_license_key'] = '授權碼：';
$_LANG['label_certificate_reset'] = 'ShopWapp證書上傳恢復';
$_LANG['label_delete_license'] = '錯誤證書刪除';
$_LANG['label_select_license'] = '選擇上傳的證書：';

/* 系統提示 */
$_LANG['delete_license_notice'] = '當您上傳了錯誤的ShopWapp證書導致證書功能失效時，請先在此處清空錯誤的證書，再使用證書上傳恢復功能恢復正確的證書。';
$_LANG['license_notice'] = 'ShopWapp證書是您享受ShopWapp服務的唯一標識，它記錄了您的網店的授權信息、購買官方服務記錄、短信賬戶等重要信息。您需要通過“證書下載備份”功能備份證書，并妥善保管。在您遇到商店系統需要重新安裝時，可以在新安裝的系統中使用“證書上傳恢復”功能將之前的證書恢復，這樣新系統就可以繼續使用證書內的重要信息。';
