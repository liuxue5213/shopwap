...
// 批量上傳商品的字段
$_LANG['export_shopwapp'] = '導出到ShopWapp數據格式';
$_LANG['shopwapp']['goods_name'] = '商品名稱';
$_LANG['shopwapp']['goods_sn'] = '商品貨號';
$_LANG['shopwapp']['brand_name'] = '商品品牌';   // 需要轉換成brand_id
$_LANG['shopwapp']['market_price'] = '市場售價';
$_LANG['shopwapp']['shop_price'] = '本店售價';
$_LANG['shopwapp']['integral'] = '積分購買額度';
$_LANG['shopwapp']['original_img'] = '商品原始圖';
$_LANG['shopwapp']['goods_img'] = '商品圖片';
$_LANG['shopwapp']['goods_thumb'] = '商品縮略圖';
$_LANG['shopwapp']['keywords'] = '商品關鍵詞';
$_LANG['shopwapp']['goods_brief'] = '簡單描述';
$_LANG['shopwapp']['goods_desc'] = '詳細描述';
$_LANG['shopwapp']['goods_weight'] = '商品重量（kg）';
$_LANG['shopwapp']['goods_number'] = '庫存數量';
$_LANG['shopwapp']['warn_number'] = '庫存警告數量';
$_LANG['shopwapp']['is_best'] = '是否精品';
$_LANG['shopwapp']['is_new'] = '是否新品';
$_LANG['shopwapp']['is_hot'] = '是否熱銷';
$_LANG['shopwapp']['is_on_sale'] = '是否上架';
$_LANG['shopwapp']['is_alone_sale'] = '能否作為普通商品銷售';
$_LANG['shopwapp']['is_real'] = '是否實體商品';
