...
// 批量上传商品的字段
$_LANG['export_shopwapp'] = 'Export to ShopWapp data format';
$_LANG['shopwapp']['goods_name'] = '商品名称';
$_LANG['shopwapp']['goods_sn'] = '商品货号';
$_LANG['shopwapp']['brand_name'] = '商品品牌';   // 需要转换成brand_id
$_LANG['shopwapp']['market_price'] = '市场售价';
$_LANG['shopwapp']['shop_price'] = '本店售价';
$_LANG['shopwapp']['integral'] = '积分购买额度';
$_LANG['shopwapp']['original_img'] = '商品原始图';
$_LANG['shopwapp']['goods_img'] = '商品图片';
$_LANG['shopwapp']['goods_thumb'] = '商品缩略图';
$_LANG['shopwapp']['keywords'] = '商品关键词';
$_LANG['shopwapp']['goods_brief'] = '简单描述';
$_LANG['shopwapp']['goods_desc'] = '详细描述';
$_LANG['shopwapp']['goods_weight'] = '商品重量（kg）';
$_LANG['shopwapp']['goods_number'] = '库存数量';
$_LANG['shopwapp']['warn_number'] = '库存警告数量';
$_LANG['shopwapp']['is_best'] = '是否精品';
$_LANG['shopwapp']['is_new'] = '是否新品';
$_LANG['shopwapp']['is_hot'] = '是否热销';
$_LANG['shopwapp']['is_on_sale'] = '是否上架';
$_LANG['shopwapp']['is_alone_sale'] = '能否作为普通商品销售';
$_LANG['shopwapp']['is_real'] = '是否实体商品';
