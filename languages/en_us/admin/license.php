...
/**
 * The ShopWapp Licensing certificate management language file
 * ============================================================================
...
/* 标签 */
$_LANG['label_certificate_download'] = 'Backup of ShopWapp certificate downloaded';
$_LANG['label_license_key'] = 'Authorization codes：';
$_LANG['label_certificate_reset'] = 'ShopWapp certificate recovery by upload';
$_LANG['label_delete_license'] = 'Delete wrong license';
$_LANG['label_select_license'] = 'Select a license to upload：';

/* 系统提示 */
$_LANG['delete_license_notice'] = 'When you uploads a wrong ShopWapp certificate making the failure of the certificate functionality, please empty wrong certificate here, then use the certificate upload recovery feature to recover the correct certificate.';
$_LANG['license_notice'] = 'ShopWapp certificate is the only mark to enjoy the ShopWapp service, it records important information such as information about your business、record of buying service、the prepaid account amounts. You need to use the function of "certificate download and backup" to backup the certificate, and keep safely. When your shop system needs to reinstall, you can use the function of "certificate download and backup" to recover the certificate backuped before in the new installed system, this new system can continue to use the important informations in the certificate.';
