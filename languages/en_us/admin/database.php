...
$_LANG['unrecognize_version'] ='Can\'t identify the ShopWapp version of the backup sql.';
...
$_LANG['version_error'] ='ShopWapp current version the %s and the backup data version the %s is different, the backup restore failure.';
