...
$_LANG['cp_home'] = 'ShopWapp PC端管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2006-2015 狗扑分享论坛www.gope.cn，并保留所有权利。';
...
$_LANG['email_list'] = '邮件管理';
$_LANG['magazine_list'] = '杂志管理';
$_LANG['attention_list'] = '关注管理';
$_LANG['view_sendlist'] = '邮件队列';

/* 积分兑换管理 */
$_LANG['15_exchange_goods'] = '积分商品';
$_LANG['15_exchange_goods_list'] = '积分商品列表';
$_LANG['exchange_goods_add'] = '添加商品';
