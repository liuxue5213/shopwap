...
$_LANG['shop_prices'] = "商城价格";
$_LANG['market_prices'] = "市场价格";
$_LANG['deposit'] = '团购保证金';
$_LANG['amount'] = "商品总价";
$_LANG['number'] = '购买数量';
$_LANG['handle'] = '操作';
...
$_LANG['notice_eg_integral'] = '积分商品需要消耗积分：';
...
$_LANG['p_y']['link_start'] = '<a href="http://www.shopwapp.com" target="_blank" style=" font-family:Verdana; font-size:11px;">';
...
$_LANG['quick_market_pirce'] = "市场价格:<del>%s</del>";
