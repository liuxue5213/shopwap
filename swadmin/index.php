...
elseif ($_REQUEST['act'] == 'license')
{
    ...
    if (isset($is_ajax) && $is_ajax)
    {
        ...
        {
            case 'login_succ':
                if (isset($license['request']['info']['service']['shopwapp_b2c']['cert_auth']['auth_str']))
                {
                    make_json_result(process_login_license($license['request']['info']['service']['shopwapp_b2c']['cert_auth']));
                }
                else
                {
                    make_json_error(0);
            ...
            case 'reg_succ':
                ...
                {
                    case 'login_succ':
                        if (isset($_license['request']['info']['service']['shopwapp_b2c']['cert_auth']['auth_str']) && $_license['request']['info']['service']['shopwapp_b2c']['cert_auth']['auth_str'] != '')
                        {
                            make_json_result(process_login_license($license['request']['info']['service']['shopwapp_b2c']['cert_auth']));
                        }
                        else
