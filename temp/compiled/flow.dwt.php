...
?> 
          ...
          <div class="cell p-quantity"> 
            ...
            <div class="quantity-form"> <a href="javascript:;" onclick="flowClickCartNum(<?php echo $this->_var['goods']['rec_id']; ?>,-1);" class="decrement">-</a>
              ...
              <a href="javascript:;" onclick="flowClickCartNum(<?php echo $this->_var['goods']['rec_id']; ?>,+1);" class="increment">+</a> </div>
            <?php else: ?> 
    ...
    <div class="cart-toolbar clearfix">
      <div class="control fl"> <span class="delete"><b></b><a href="javascript:;" id="remove-batch">删除选中的商品</a></span> </div>
      <div class="total fr">
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="image" src="themes/swdefault/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
            </tr>
            <?php endif; ?>
          </table>
...
?>
    ...
    <img style="float:left" src="themes/swdefault/images/flow_bottom.gif"> </div>
  <?php endif; ?> 
...
?>
        ...
        <div class="flowBox">
          ...
          <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/swdefault/images/bnt_subOrder.gif" />
          ...
          <form action="flow.php?step=login" method="post" name="formUser" id="registerForm" onsubmit="return checkSignupForm(this)">
            <table width="98%" border="0" cellpadding="8" cellspacing="0" bgcolor="#B0D8FF" class="table">
              <tr>
                ...
                <td bgcolor="#ffffff"><input name="username" type="text" class="input_text1" id="username" onblur="is_registered(this.value);" />
                  <br />
              ...
              <tr>
                ...
                <td bgcolor="#ffffff"><input name="email" type="text" class="input_text1" id="email" onblur="checkEmail(this.value);" />
                  <br />
              ...
              <tr>
                ...
                <td bgcolor="#ffffff"><input name="password" class="input_text1" type="password" id="password1" onblur="check_password(this.value);" onkeyup="checkIntensity(this.value)" />
                  <br />
                  <span style="color:#FF0000" id="password_notice"></span></td>
              </tr>
              <tr>
                <td bgcolor="#ffffff" align="right"><strong><?php echo $this->_var['lang']['confirm_password']; ?></strong></td>
                <td bgcolor="#ffffff"><input name="confirm_password" class="input_text1" type="password" id="confirm_password" onblur="check_conform_password(this.value);" />
                  <br />
