...
?>
  <tr>
    ...
    <td align="center">
      ...
      <?php else: ?>
      <a <?php if ($this->_var['module']['code'] != "shopwapp"): ?>href="javascript:confirm_redirect('<?php echo $this->_var['lang']['install_confirm']; ?>', 'integrate.php?act=install&code=<?php echo $this->_var['module']['code']; ?>')"<?php else: ?>href="integrate.php?act=install&code=<?php echo $this->_var['module']['code']; ?>" <?php endif; ?>><?php echo $this->_var['lang']['install']; ?></a>
      <?php endif; ?>
    </td>
  </tr>
