...
?>
  <tr>
    ...
    <td align="left"><span><?php if ($this->_var['list']['position_id'] == 0): ?><?php echo $this->_var['lang']['outside_posit']; ?><?php else: ?><?php echo $this->_var['list']['position_name']; ?><?php endif; ?></span></td>
    <td align="center"><span><?php echo $this->_var['list']['type']; ?></span><br><a href="../data/afficheimg/<?php echo $this->_var['list']['ad_code']; ?>" target="_blank"><img src="../data/afficheimg/<?php echo $this->_var['list']['ad_code']; ?>" border="0" width="100" /></a></td>
