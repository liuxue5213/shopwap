...
<table cellpadding="3" cellspacing="1">
  <tr>
	...
	<th><a href="javascript:listTable.sort('cat_name'); ">分类</a><?php echo $this->_var['sort_cat_name']; ?></th>
	<th><a href="javascript:listTable.sort('brand_name'); ">品牌</a><?php echo $this->_var['sort_brand_name']; ?></th>
...
?>
  <tr>
	...
	<td align="center"><a href="../goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="<?php if (strpos ( $this->_var['goods']['goods_thumb'] , 'ttp' ) > 0): ?><?php else: ?>../<?php endif; ?><?php echo $this->_var['goods']['goods_thumb']; ?>" width="50" height="50" border="0" /></td>
	...
	<td align="center"><?php echo $this->_var['goods']['cat_name']; ?></td>
	<td align="center"><?php echo $this->_var['goods']['brand_name']; ?></td>
