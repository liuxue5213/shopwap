...
<div class="tab-div"> 
  ...
  <div id="tabbar-div">
    <p><span
      class="tab-front" id="general-tab"><?php echo $this->_var['lang']['tab_general']; ?></span><span
      class="tab-back" id="detail-tab"><?php echo $this->_var['lang']['tab_detail']; ?></span><span
      class="tab-back" id="packing-tab">包装清单</span><span
      class="tab-back" id="customer-tab">售后保障</span><span
...
?>
      ...
      <table width="100%" id="packing-table" style="display:none">
        <tr>
      ...
      <table width="100%" id="customer-table" style="display:none">
        <tr>
...
?>
      ...
      <!-- 鍏宠仈鍟嗗搧 -->
      <table width="100%" id="linkgoods-table" style="display:none" align="center">
        <!-- 鍟嗗搧鎼滅储 -->
        <tr>
...
?>
      ...
      <!-- 鍏宠仈鏂囩珷 -->
      <table width="100%" id="article-table" style="display:none" align="center">
        <!-- 鏂囩珷鎼滅储 -->
        <tr>
...
<style type="text/css">
#feedbox{margin:0; padding:0 ;border:#3c792b 2px solid;margin:2px 0 0 2px;background:#fff; height:auto;float:left;overflow:hidden;width:536px; cursor:pointer;position:absolute;top:0px;left:0px;filter:alpha(opacity=100);opacity:1; left:30%; top:8%; margin-right:-268px;}
