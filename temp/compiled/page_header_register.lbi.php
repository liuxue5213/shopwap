 ...
 <!--      <li class="fore3 ld menu" id="app-jd"><s></s><i></i><span class="outline"></span><span class="blank"></span><a href="#" target="_blank">手机商城</a><b></b>
        <div class="dd lh">
          ...
          <div class="qr-item qr-jd-app">
            <div class="qr-img"><img id="app-qrcode-img" src="themes/swdefault/images/538557daNd249a428.png" width="76" height="76" alt="手机商城" src="themes/swdefault/images/blank.gif"></div>
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="./index.php"><img src="themes/swdefault/images/logo.gif" title="返回<?php echo $this->_var['shop_name']; ?>首页" alt="返回<?php echo $this->_var['shop_name']; ?>首页"></a></div>
</div>