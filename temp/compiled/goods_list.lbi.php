...
?>
        ...
        <li>
          <div class="lh-wrap">
            ...
            <div class="btns"><a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="btn-buy">加入购物车</a><a id="coll647948" href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);" class="btn-coll">关注</a><a id="comp_<?php echo $this->_var['goods']['goods_id']; ?>" onClick="Compare.add(<?php echo $this->_var['goods']['goods_id']; ?>,'<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>','<?php echo $this->_var['goods']['type']; ?>')" class="btn-compare btn-compare-s"><span></span>对比</a></div>
            </div>
        </li>
            <?php endif; ?>
