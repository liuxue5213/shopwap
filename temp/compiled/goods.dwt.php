    ...
    <div id="i-comment">
      ...
      <div class="btns">
        <div><?php if ($this->_var['factor'] == 0): ?>所有用户都可以对该商品<br />
          <a href="javascript:;" class="open_comment">【发表评论】</a><?php elseif ($this->_var['factor'] == 1): ?>只有登陆的用户才可以对该商品<br />
          <a href="javascript:;" class="open_comment">【发表评论】</a><?php elseif ($this->_var['factor'] == 2): ?>在本站购买过一次其他商品的用户才可以对该商品<br />
          <a href="javascript:;" class="open_comment">【发表评论】</a><?php elseif ($this->_var['factor'] == 3): ?>购买过此<?php echo $this->_var['goods_name']; ?>的顾客，在收到商品才可以对该商品<br />
          <a href="javascript:;" class="open_comment">【发表评论】</a><?php endif; ?> </div>
      </div>
    </div>
  </div>
</div>
