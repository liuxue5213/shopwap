...
?> 
                    ...
                    <li><a href="javascript:;" class="curr"><?php echo $this->_var['brand']['brand_name']; ?></a></li>
                    <?php else: ?>
...
?> 
                    ...
                    <li><a href="javascript:;" class="curr"><?php echo $this->_var['grade']['price_range']; ?></a></li>
                    <?php else: ?>
          ...
          <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_18456900_1440733182');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_18456900_1440733182']):
?>
          <div class="prop-attrs">
            <div class="attr">
              <div class="a-key"><?php echo htmlspecialchars($this->_var['filter_attr_0_18456900_1440733182']['filter_attr_name']); ?>：</div>
              <div class="a-values">
                <div class="v-fold">
                  <ul class="f-list">
                    <?php $_from = $this->_var['filter_attr_0_18456900_1440733182']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
    foreach ($_from AS $this->_var['attr']):
?> 
                    <?php if ($this->_var['attr']['selected']): ?>
                    <li><a href="javascript:;" class="curr"><?php echo $this->_var['attr']['attr_value']; ?></a></li>
                    <?php else: ?>
