...
function insert_history()
{
    ...
    if (!empty($_COOKIE['ECS']['history']))
    {
		...
		$str .= '<li class="all-recent" style="text-align:right;padding:5px 0;"><a href="javascript:;" onclick="clear_history()" style="color:#005ea7;">清除浏览历史 <span style="font-family:simsun;">&gt;</span></a></li>';
