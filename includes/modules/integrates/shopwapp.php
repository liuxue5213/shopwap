 ...
 * ============================================================================
 * $Author: liubo $
 * $Id: shopwapp.php 17217 2011-01-19 06:29:08Z liubo $
 */
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['code']    = 'shopwapp';

    /* 被整合的第三方程序的名称 */
    $modules[$i]['name']    = 'ShopWapp';

    /* 被整合的第三方程序的版本 */
    $modules[$i]['version'] = '2.0';

    /* 插件的作者 */
    $modules[$i]['author']  = 'ShopWapp TEAM';

    /* 插件作者的官方网站 */
    $modules[$i]['website'] = 'http://www.shopwapp.com';

    return;
}

require_once(ROOT_PATH . 'includes/modules/integrates/integrate.php');
class shopwapp extends integrate
{
    var $is_shopwapp = 1;
